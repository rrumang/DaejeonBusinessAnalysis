...
<script>
	$(document).ready(function(){
		...
		$("#gu").on("change", function(){
			//alert($("#gu").val());
			$.ajax({
				url : "${pageContext.request.contextPath}/location/inputDong",
				method : "post",
...
<div class="box-center col-lg-10 mt-5 pt-4">
		...
		<div class="card shadow mb-4">
			<div>
				<div class="mb-4 pt-3 border-bottom-info">
					<div class="card-body">
						<h4 class="font-weight-bold text-primary text-center">입&nbsp;지&nbsp;분&nbsp;석</h4>
					</div>
				</div>
			</div>

			<div id="selectR" class="container">
				<h6 class="font-weight-normal text-black text-wrap">1.&nbsp;지역선택</h6>
				...
				<div id="regionSelect" class="card-body mt-3">
					...
					<select class="custom-select w-49" id="dong">
						...
						<c:forEach items="${regionList}" var="rList"> <%-- 관심지역이 없을 경우 기본값을 설정한다 --%>
							<c:if test="${rList.region_cd2 == 30110}">
				...
				<hr>
				<div>
					<div id="btntob" class="card-body mt-2">
	...
	<form id="form1" action="${pageContext.request.contextPath}/location/locationReport" method="post">
