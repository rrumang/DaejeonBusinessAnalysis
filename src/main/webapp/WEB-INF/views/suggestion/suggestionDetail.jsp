...
<script>
	$(document).ready(function() {
		...
		$("#modify").on("click",function(){
			...
			$("#addBtn").attr("style","display:inline-block; float:right;");
			$("#check").css("display","inline-block");
			$(this).css("display","none");
			$("#su_title").attr("readonly",false);
			$("#su_content").attr("readonly",false);
			$("#chum2").css("display","block");
			$("#chum1").css("display","none");
...
<body>
	<div id="div01" class="col-sm-10 col-sm-offset-3">
		...
		<form action="${pageContext.request.contextPath }/suggestionModify"
			method="post" id="frm2" enctype="multipart/form-data">
			...
			<br> <br>
			<h5 class="font-weight-bold text-primary" style="float:left">첨부파일</h5>
			<div class="text-right">
				<a href="#" id="addBtn" style="display:none;" class="btn btn-primary mb-2">첨부하기</a>
			</div>
			
			<hr style="clear : both;">

			<div id="div03" class="col-sm-11">
				<dl>
					<c:choose>
						...
						<c:otherwise>
							<c:forEach items="${attachList}" var="attachVo">
								...
								<dd id="chum2" style="display:none;">
									<label class="label01">${attachVo.attach_name}</label>
